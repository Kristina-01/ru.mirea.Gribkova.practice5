package ru.mirea.gribkova.audiorecord;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startRecordButton.setOnClickListener(this::onClickStart);
        stopRecordButton = (Button) findViewById(R.id.btnStop);
        stopRecordButton.setOnClickListener(this::onClickStop);
    ...
    private void onClickStart(View view){
        ...
        try {
            ...
            Log.e(TAG, "Ошибка io " + e.getMessage());
        }
    }
    ...
    private void stopRecording(){
        if(mediaRecorder != null){
            ...
            mediaRecorder = null;
            Toast.makeText(this, "Запись остановилась",
